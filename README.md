...
De partida vienen cargadas 5.498 compras entre diciembre de 2025 y septiembre de
2026, por 147.220 € y 537 referencias: el histórico completo de Makro de
...
- **Sasa Alimentació** es la continuidad de Balart Subirana, así que las compras
  de las dos van juntas bajo el nombre de Sasa. En el número de factura se ve cuál
  de las dos emitió cada línea, y la serie de precios no se corta en mayo.
- De la etapa Balart están cargadas las 16 referencias de más peso, que suman entre
  el 74 % y el 80 % del importe de cada factura. El resto del catálogo, muy
  fragmentado, quedó fuera. Los precios que figuran son correctos; los totales de
  esos meses están cortos.
- Las facturas emitidas ya como Sasa solo listan albaranes con su importe, sin
  detalle de producto. De 18 albaranes de Santamasa Sarrià sí se pudo descargar el
  detalle del sistema propio, y esos 202 apuntes están cargados con su precio. El
  resto del gasto de Sasa entra como una línea al mes llamada «Compra del mes»:
  aparece en el gasto por proveedor pero nunca en las variaciones de precio.
- En esos albaranes la columna de unidad no es fiable: etiqueta como caja o saco lo
  que en muchas líneas es un precio por kilo. Los precios cargados están
  normalizados a la unidad real, comparando cada línea con las del mismo producto
  facturadas por kilo. Por eso el precio del panel no siempre coincide con el que
  se lee en el albarán.
